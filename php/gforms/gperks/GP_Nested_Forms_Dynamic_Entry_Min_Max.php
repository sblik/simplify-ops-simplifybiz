...
/**
 *  This script is used to limit the maximum amount of repeater entries can be subitted for
...
//add_filter( 'gpnf_entry_limit_max', 'ticket_nest_form_limit' );
//
//
//add_action( 'wp_ajax_ticket_nest_form_limit', 'ticket_nest_form_limit' );
//add_action( 'wp_ajax_nopriv_ticket_nest_form_limit', 'ticket_nest_form_limit' );
