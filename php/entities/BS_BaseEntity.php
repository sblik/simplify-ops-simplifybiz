...
abstract class BS_BaseEntity {
	...
	/**
	 * Get the form id that is mapped to a specif property on the entity
	 *
	 * @param $property_name
	 *
	 * @return mixed|null
	 */
	public static function get_form_id( $property_name ) {
	 ...
	 * In the context of the BSBaseEntity class, the __get method is used to retrieve the value of a property from the formEntry array.
	 *
	 * @param $property
	 *
	 * @return mixed|null
	 ...
	 * In the context of the BSBaseEntity class, the __set method is used to set the value of a property in the formEntry array.
	 *
	 * @param $property
	 * @param $value
	 *
