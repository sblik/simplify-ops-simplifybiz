<?php
	...
	abstract class BS_BaseRepository {
		 ...
		 * @return T[]
		 */
		private static function get ( $fieldId, $value, string $direction = 'ASC', $paging = null ): array {
		 ...
		 * @return T|null
		 */
		static function get_one_for_user ( string $userId ) {
		 ...
		 * @return T[]|WP_Error
		 */
		public static function get_all ( $fieldId, $value, string $direction = 'ASC' ): array {
