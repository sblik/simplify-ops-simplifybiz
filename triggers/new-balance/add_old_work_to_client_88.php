...
BS_Log::info("FUNCTION 88 TRIGGERED");
$ops_form_id = 50;
 ...
 */
$clients_form_id = 150;
$search_criteria['field_filters'][] = array('key' => '3', 'value' => 88);
$search_criteria['status'][] = 'active';
$sorting = array('key' => 'id', 'direction' => 'DESC', 'is_numeric' => true);
$client_entries_3 = GFAPI::get_entries($clients_form_id, $search_criteria, $sorting);
BS_Log::info($client_entries_3[0]);
...
for ($i = 0; $i < $count_ops_entries; $i++) {
    ...
    BS_Log::info($client_entries_3[0]);
    BS_Log::info("CLIENT ENTRY USER ID: " . $client_entries_3[0][2]);
        ...
        $new_child_entry = array(
                ...
                '7' => $workCompleted,
                '8' => $hoursSpent,
                GPNF_Entry::ENTRY_PARENT_KEY => $client_entries_3[0]['id'], // The ID of the parent entry.
